package br.unesp.br.springtutorialmongodb.utils;

import java.util.Date;

import br.unesp.br.springtutorialmongodb.entity.Acesso;
import br.unesp.br.springtutorialmongodb.entity.Contato;
import br.unesp.br.springtutorialmongodb.entity.Endereco;
